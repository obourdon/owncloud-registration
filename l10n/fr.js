OC.L10N.register(
    ...
    "A new user \"%s\" %s has created an account on %s" : "Un nouvel utilisateur \"%s\" %s a créé un compte sur %s",
    ...
    "A new user \"%s\" %s has created an account on %s and awaits admin approbation" : "Un nouvel utilisateur \"%s\" %s a créé un compte sur %s et attend l'approbation d'un administrateur",
