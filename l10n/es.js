OC.L10N.register(
    ...
    "A new user \"%s\" %s has created an account on %s" : "Un nuevo usuario \"%s\" %s ha creado una cuenta en %s",
    ...
    "A new user \"%s\" %s has created an account on %s and awaits admin approbation" : "El nuevo usuario \"%s\" %s ha sido creado en la cuenta %s y espera aprobación del administrador",
