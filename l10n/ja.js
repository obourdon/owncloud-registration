OC.L10N.register(
    ...
    "A new user \"%s\" %s has created an account on %s" : "新しいユーザー \"%s\" を アカウント名 \"%s\" %s として作成しました",
    ...
    "A new user \"%s\" %s has created an account on %s and awaits admin approbation" : "新しいユーザー \"%s\" を アカウント名 \"%s\" %s として作成しました、今管理者の承認は必要です",
