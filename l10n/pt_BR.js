OC.L10N.register(
    ...
    "A new user \"%s\" %s has created an account on %s" : "Um novo usuário \"%s\" %s criou uma conta em %s",
    ...
    "A new user \"%s\" %s has created an account on %s and awaits admin approbation" : "Um novo usuário \"%s\" %s criou uma conta em %s e aguarda aprovação de um administrador",
