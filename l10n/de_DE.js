OC.L10N.register(
    ...
    "A new user \"%s\" %s has created an account on %s" : "Ein neuer Benutzer \"%s\" %s hat sich ein neues Konto angelegt bei %s",
    ...
    "A new user \"%s\" %s has created an account on %s and awaits admin approbation" : "Ein Neuer Benutzer \"%s\" %s hat ein Konto auf %s erstellt und wartet auf eine Freigabe durch den Administrator",
