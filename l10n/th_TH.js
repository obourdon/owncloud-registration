OC.L10N.register(
    ...
    "A new user \"%s\" %s has created an account on %s" : "ผู้ใช้ใหม่ \"%s\" %s ได้สร้างบัญชีผู้ใช้บน %s",
    ...
    "A new user \"%s\" %s has created an account on %s and awaits admin approbation" : "ผู้ใช้ใหม่ชื่อ \"%s\" %s ได้สร้างบัญชีบน %s แล้วและกำลังรอการอนุมัติจากผู้ดูแลระบบ",
